...
const Navbar = () => {
  return (
    <div id='navbar' data-aos="fade-down" className='flex flex-col lg:flex-row justify-between items-center px-5 lg:px-10 py-5 bg-amber-50 gap-5 '>
      ...
      <button className='p-4 bg-black text-white rounded-3xl text-2xs w-44 m font-medium uppercase hover:bg-blue-500 '><a className='flex gap-1.5' href={resume} download={resume} >Download CV <img className='w-5' src={File} alt="" /></a></button>
    </div>
  )
}
