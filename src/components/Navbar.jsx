...
const Navbar = () => {
  return (
    <div id='navbar' data-aos="fade-down" className='flex justify-between items-center px-5 py-5 bg-amber-50 gap-5 '>
      ...
      <ul  className='relative flex flex-wrap justify-center gap-5  font-bold text-2xl text-gray-500 rounded-2xl border-2 p-2 w-7xl border-black backdrop-blur-2xl- backdrop-brightness-200 sm:justify-center'>
